    ...
    return this.each(function() {
      $(this).animate({
        ...
        step: function( progress ){
          ...
          if (Math.ceil(progress) < 5 && $('.ui-label', this).is(":visible")) {
            labelEl.hide();
          }else{
...
$(function() {
  ...
  // Simulate some progress
  $('#progress_bar4 .ui-progress').animateProgress(50, function() {
    $(this).animateProgress(55, function() {
      setTimeout(function() {
        $('#progress_bar4 .ui-progress').animateProgress(50, function() {
          $('#main_content').slideDown();
          $('#fork_me').fadeIn();
...
$(function() {
  ...
  // Simulate some progress
  $('#progress_bar5 .ui-progress').animateProgress(15, function() {
...
$(function() {
  ...
  // Simulate some progress
  $('#progress_bar_gray .ui-progress3').animateProgress(100, function() {
    $(this).animateProgress(100, function() {
      setTimeout(function() {
        $('#progress_bar_gray .ui-progress3').animateProgress(100, function() {
          $('#main_content').slideDown();
...
$(function() {
  ...
  // Simulate some progress
  $('#progress_bar_gray4 .ui-progress3').animateProgress(50, function() {
...
$(function() {
  ...
  // Simulate some progress
  $('#progress_bar_gray5 .ui-progress3').animateProgress(15, function() {
    $(this).animateProgress(15, function() {
      setTimeout(function() {
        $('#progress_bar_gray5 .ui-progress3').animateProgress(15, function() {
          $('#main_content').slideDown();
          $('#fork_me').fadeIn();
